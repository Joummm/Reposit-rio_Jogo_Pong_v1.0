...
namespace Pong
{
    internal class Program : GameWindow
    {
        ...
        int velocidadeResumeEmX, velocidadeResumeEmY;
        int yDoJogador1 = 0;
        int yDoJogador2 = 0;
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            if (yDaBola + tamanhoDaBola / 2 > ClientSize.Height / 2)
            {
                ...
                velocidadeResumeEmY = velocidadeDaBolaEmY;
            }

            if (yDaBola - tamanhoDaBola / 2 < -ClientSize.Height / 2)
            {
                velocidadeResumeEmX = velocidadeDaBolaEmY = -velocidadeDaBolaEmY;
            }
            ...
            if (Keyboard.GetState().IsKeyDown(Key.R))
            {
                ...
                yDoJogador1 = 0;
                yDoJogador2 = 0;
                velocidadeDaBolaEmY = 13;
                velocidadeDaBolaEmX = 13;
            }

            if (Keyboard.GetState().IsKeyDown(Key.P))
            {
                velocidadeDaBolaEmX = 0;
                velocidadeDaBolaEmY = 0;
            }

            if (Keyboard.GetState().IsKeyDown(Key.C))
            {
                velocidadeDaBolaEmY = velocidadeResumeEmY;
                velocidadeDaBolaEmX = velocidadeResumeEmX;
            }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            DesenharRetangulo(xDoJogador2(), yDoJogador2, larguraDosJogadores(), alturaDosJogadores(), 0.0f, 1.0f, 0.0f);
